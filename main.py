from structural.decorator.coffee_shop.concrete_components.dark_roast import DarkRoast
...
from structural.decorator.coffee_shop.concrete_decorator.Soy import Soy
